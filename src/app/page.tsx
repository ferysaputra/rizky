    ...
    <div className="min-h-screen bg-gradient-to-b from-[#fdf6f9] via-white to-[#fef0f5] flex flex-col items-center justify-center px-6 py-12">
      ...
      <div className="relative text-center max-w-lg animate-slide-up">
        ...
        <div className="flex items-center justify-center gap-2 mb-4">
          ...
          <span className="text-sm font-semibold text-primary uppercase tracking-widest">Welcome to</span>
          <Sparkles size={16} className="text-primary" />
        </div>
        ...
        <p className="text-muted text-base leading-relaxed max-w-md mx-auto mb-10">
          Your personal health companion. Track your cycle, manage notes, read health articles, and get support — all in one place.
        </p>

        {/* CTA Buttons */}
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <Link href="/app" className="btn-primary flex items-center gap-2 text-base px-8 py-3.5">
