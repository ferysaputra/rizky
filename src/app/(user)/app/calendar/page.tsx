...
export default function CalendarPage() {
    const [lastPeriodDate] = useState(new Date('2026-02-10'));
    ...
    return (
        <div className="animate-fade-in">
                        ...
                        <div className="space-y-3">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <select className="input-field text-sm appearance-none pr-8" defaultValue="28">
            ...
            {/* Calendar */}
            <div className="px-5 mb-5">
                <CalendarGrid lastPeriodDate={lastPeriodDate} cycleLength={cycleLength} />
            </div>
            ...
            <div className="px-5 mb-5">
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div className="glass-card p-3 border-l-3 border-l-period-red">
                        ...
                        <p className="text-[10px] text-muted">Days 1–5</p>
                    </div>
                    <div className="glass-card p-3 border-l-3 border-l-fertile-green">
                        ...
                        <p className="text-[10px] text-muted">Days 9–15</p>
                    </div>
                    <div className="glass-card p-3 border-l-3 border-l-ovulation-purple">
                        ...
                        <p className="text-[10px] text-muted">Day 14</p>
                    </div>
                    <div className="glass-card p-3 border-l-3 border-l-warning">
                        ...
                        <p className="text-[10px] text-muted">Days 15–28</p>
                    </div>
                </div>
            </div>
        </div>
